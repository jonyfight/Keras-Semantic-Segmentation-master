...
if __name__=="__main__":
    ...
    # main(path)
    mymovefile('F:\\BRD_data\\Segmentation_BRD\\初步打标数据\\png\\安徽区域二部-亳州春暖花开-合同-洋房-7#.png','F:\\BRD_data\\Segmentation_BRD\\初步打标数据\\1\\安徽区域二部-亳州春暖花开-合同-洋房-7#.png')
    # move_json_png(read_data_path(path, "png"))