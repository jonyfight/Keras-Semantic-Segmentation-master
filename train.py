...
parser.add_argument("--n_classes", type=int, default=2)  # 2
parser.add_argument("--input_height", type=int, default = 224)  # 224
parser.add_argument("--input_width", type=int, default = 224)  # 224
...
parser.add_argument("--train_batch_size", type = int, default = 8)  # 4
parser.add_argument("--val_batch_size", type = int, default = 8)  # 4
parser.add_argument("--train_save_path", type = str, default = "weights/unet")
parser.add_argument("--resume", type=str, default="")  # 导入权重文件
parser.add_argument("--model_name", type = str, default = "unet_resnet")  # unet
parser.add_argument("--optimizer_name", type=str, default="sgd")  # sgd
parser.add_argument("--image_init", type=str, default="sub_mean")  # sub_mean
...
modelFns = {'enet':Models.ENet.ENet,
			...
			'unet_resnet':Models.Unet_resnet.Unet_resnet
			}
...
model.compile(loss='categorical_crossentropy', optimizer= optimizer_name, metrics=['accuracy'])  # categorical_crossentropy
