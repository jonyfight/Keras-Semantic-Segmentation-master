...
parser.add_argument("--weights_path", type=str, default="weights/unet.07-0.988924.hdf5")  # unet.18-0.856895
parser.add_argument("--model_name", type=str, default="unet")  # unet
parser.add_argument("--input_height", type=int, default=224)
parser.add_argument("--input_width", type=int, default=224)
parser.add_argument("--classes", type=int, default=2)  # 2
parser.add_argument("--mIOU", type=bool, default=True)  # False
